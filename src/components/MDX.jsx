...
const mdxComponents = {
  ...
  h2: (props) => <Typography variant="h2" anchor={true} {...props} />,
  h3: (props) => <Typography variant="h3"  anchor={true} {...props} />,
  h4: (props) => <Typography variant="h4" anchor={true} {...props} />,
  h5: (props) => <Typography variant="h5" anchor={true} {...props} />,
  h6: (props) => <Typography variant="h6" anchor={true} {...props} />,
